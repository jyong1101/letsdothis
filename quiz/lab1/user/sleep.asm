...
int main(int argc, char *argv[]) {
   ...
   a:	00a7df63          	bge	a5,a0,28 <main+0x28>
     ...
     if (argc != 2) {
   e:	4789                	li	a5,2
  10:	02f50663          	beq	a0,a5,3c <main+0x3c>
        fprintf(2, "usage sleep <ticks>/n");
  14:	00001597          	auipc	a1,0x1
  18:	8c458593          	addi	a1,a1,-1852 # 8d8 <malloc+0x10e>
  1c:	4509                	li	a0,2
  1e:	6ce000ef          	jal	6ec <fprintf>
        exit(1);
  22:	4505                	li	a0,1
  24:	2be000ef          	jal	2e2 <exit>
        fprintf(2, "wrong");
  28:	00001597          	auipc	a1,0x1
  2c:	8a858593          	addi	a1,a1,-1880 # 8d0 <malloc+0x106>
  30:	4509                	li	a0,2
  32:	6ba000ef          	jal	6ec <fprintf>
        exit(1);
  36:	4505                	li	a0,1
  38:	2aa000ef          	jal	2e2 <exit>
    ...
    int ticks = atoi(*argv);
  3c:	6188                	ld	a0,0(a1)
  3e:	182000ef          	jal	1c0 <atoi>
    pause(ticks);    
  42:	330000ef          	jal	372 <pause>
    exit(0);
  46:	4501                	li	a0,0
  48:	29a000ef          	jal	2e2 <exit>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3c2:	53a50513          	addi	a0,a0,1338 # 8f8 <digits>
 3c6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 660:	29cb8b93          	addi	s7,s7,668 # 8f8 <digits>
 ...
 6c2:	23290913          	addi	s2,s2,562 # 8f0 <malloc+0x126>
        for(; *s; s++)
